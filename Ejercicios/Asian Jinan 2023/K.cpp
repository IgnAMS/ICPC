        ...
        rep(i, n) {
            ...
            while(oc and r <= n - 2) {
                ...
                if(largo & 1) {
                    ...
                    ll count_left = st.contar(0, mediana - 1, 0, n, 0);
                    ll count_right = st.contar(mediana + 1, n, 0, n, 0);
                    ll sum_left = st.suma(0, mediana - 1, 0, n, 0);
                    ll sum_right = st.suma(mediana + 1, n, 0, n, 0);
                    ...
                    ll count_left2 = st.contar(0, mediana2 - 1, 0, n, 0);
                    ll count_right2 = st.contar(mediana2 + 1, n, 0, n, 0);
                    ll sum_left2 = st.suma(0, mediana2 - 1, 0, n, 0);
                    ll sum_right2 = st.suma(mediana2 + 1, n, 0, n, 0);
